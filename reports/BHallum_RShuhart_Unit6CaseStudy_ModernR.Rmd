...
for (i in 1:range(20)){
  k[i] <- i
  MSE[i] <- k_compare_func(trainPosX_X[,keep_ddcd_sigs], 
                           trainPosY_X[,keep_ddcd_sigs], 
                           testPosX_X[,keep_ddcd_sigs],
                           testPosY_X[,keep_ddcd_sigs], validatation, i)
}
...
for (i in 1:range(20)){
  k[i] <- i
  MSE[i] <- k_compare_func(trainPosX_X[,keep_e1c0_sigs], 
                           trainPosY_X[,keep_e1c0_sigs], 
                           testPosX_X[,keep_e1c0_sigs],
                           testPosY_X[,keep_e1c0_sigs], validatation, i)
}
